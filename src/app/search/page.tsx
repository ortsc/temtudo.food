  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gray-50 flex flex-col">
        {/* Header */}
        <header className="bg-gradient-to-r from-primary to-primary-dark text-white px-6 py-4 flex items-center gap-4 sticky top-0 z-50">
          <Link 
            href="/"
        ...
        {/* Content */}
        <div className="flex-1 px-4 py-6 -mt-4 bg-gray-50 rounded-t-3xl relative z-10">
          {/* Search Input */}
          <div className="mb-6">
            <ProductSearchInput
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="mb-4">
                ...
                <p className="text-sm text-gray-500">Ordenado por menor preço</p>
              </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        comprando no {markets[0].nome_mercado} ao invés do {markets[markets.length - 1].nome_mercado}
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="text-center py-12">
              ...
              <p className="text-sm text-gray-400 mt-1">
                Digite o nome do produto para comparar preços
              </p>
            </div>
          ) : null}
        </div>
